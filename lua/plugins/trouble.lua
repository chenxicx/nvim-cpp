return {
  ...
  keys = {
    { "<leader>xx", "<cmd>Trouble<cr>", desc = "打开Trouble" },
    { "<leader>xw", "<cmd>Trouble diagnostics toggle focus=false filter.buf=0<cr>", desc = "当前文档诊断" },
    { "<leader>xl", "<cmd>Trouble loclist<cr>", desc = "位置列表" },
    { "<leader>xq", "<cmd>Trouble quickfix<cr>", desc = "快速修复" },
    { "<leader>xr", "<cmd>Trouble lsp<cr>", desc = "LSP所有" },
    { "gR", "<cmd>Trouble lsp_references<cr>", desc = "显示引用" },
