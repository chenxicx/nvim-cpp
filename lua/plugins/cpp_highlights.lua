return {
  -- 这是一个自定义插件配置，用于高亮 C/C++ 特殊注释
  {
    ...
    config = function()
      -- 创建高亮组
      vim.api.nvim_set_hl(0, "CppNoteComment", { fg = "#10B981", bold = true })
      vim.api.nvim_set_hl(0, "CppQuestionComment", { fg = "#2563EB", bold = true })
      vim.api.nvim_set_hl(0, "CppErrorComment", { fg = "#DC2626", bold = true })
      -- 添加默认注释的高亮组（灰色）
